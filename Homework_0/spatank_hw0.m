...
%%
% ANSWER HERE
% The first letter of an electrode's name denotes the region of the brain
% from which it records signals. Fp stands for pre-frontal, F for frontal, 
% C for central, P for parietal, O for occipital, and T for temporal. These
% are appended to with numbers that denote which side of the head the
% electrode is placed at. Odd numbered electrodes are placed on the
% left-hand side of the skull, and even numbered electrodes on the
% right-hand side. Electrodes placed along the nasion-inion axis do not
% take a number, instead taking the letter z. 
